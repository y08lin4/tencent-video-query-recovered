...
- `25`：当前稳定命中 `飞驰人生・三部连看`、`2026大片一次看够`、`熊抱快乐！熊出没大电影连看`
- `62`：当前只在 `我的心略大于整个宇宙` 命中
...
- `positive_trailer=0` 很像“非 canonical 主详情页”的 cover 标记
- 它至少覆盖电影合集页、电影片单页、以及一类微综艺 / 轻内容页
